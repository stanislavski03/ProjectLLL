...
using TMPro;
using UnityEngine.UI; // Добавляем для работы с Toggle

public class Settings : MonoBehaviour
{
    public TMP_Dropdown resolutionDropdown;
    public TMP_Dropdown qualityDropdown;
    public Toggle fullscreenToggle; // Добавляем ссылку на Toggle
    ...
    void Start()
    {
        ...
        // Устанавливаем обработчик изменения значения Toggle
    ...
    public void LoadSettings(int currentResolutionIndex)
    {
        ...
        // Применяем настройку полноэкранного режима
        Screen.fullScreen = isFullscreen;
